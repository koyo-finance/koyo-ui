...
const generatedTemplates = templates.map((template) => template(componentName, directoryName));
...
fs.appendFileSync(`./src/${directoryName}/index.ts`, `export * from './${componentName}';\n`);
